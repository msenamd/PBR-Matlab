...
function [temp, x_ws, x_ds, x_c, x_a, Y_O2, pres, ...
...
for i=1:nx_new
    ...
    if(ii > 0) 
     ...
     +(pres_old(ii+1)-pres_old(ii))*(xCenter(i)       -xCenter_old(ii)) ...
        ...
        sum_R1_0(i) = sum_R1_old(ii) ...
 +(sum_R1_old(ii+1)-sum_R1_old(ii))*(xCenter(i)       -xCenter_old(ii)) ...
                                   /(xCenter_old(ii+1)-xCenter_old(ii));
                               
        sum_R2_0(i) = sum_R2_old(ii) ...
 +(sum_R2_old(ii+1)-sum_R2_old(ii))*(xCenter(i)       -xCenter_old(ii)) ...
                                   /(xCenter_old(ii+1)-xCenter_old(ii));
                               
        sum_R3_0(i) = sum_R3_old(ii) ...
 +(sum_R3_old(ii+1)-sum_R3_old(ii))*(xCenter(i)       -xCenter_old(ii)) ...
                                   /(xCenter_old(ii+1)-xCenter_old(ii));
                               
        sum_R4_0(i) = sum_R4_old(ii) ...
 +(sum_R4_old(ii+1)-sum_R4_old(ii))*(xCenter(i)       -xCenter_old(ii)) ...
                                   /(xCenter_old(ii+1)-xCenter_old(ii));
    end
